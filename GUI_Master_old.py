...
lbl = tk.Label(root, text="Comparison of Clustering Methods for Obesity Classification", font=('times', 35,' bold '), height=1, width=62,bg="#560319",fg="white")
lbl.place(x=0, y=0)
# _+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
def DT():
    data = pd.read_csv("F:/2023 project code/New folder/100 % code/Train.csv")
    data.head()
